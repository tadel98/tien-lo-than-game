...
import { computed, watch, unref, mergeProps, withCtx, createVNode, toDisplayString, ref, createTextVNode, useSSRContext } from 'file://C:/Users/THE%20SUN/Desktop/TienLoThan/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderClass } from 'file://C:/Users/THE%20SUN/Desktop/TienLoThan/node_modules/vue/server-renderer/index.mjs';
      ...
      if (!unref(isAuthenticated)) {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            var _a2, _b2, _c2, _d2;
            if (_push2) {
              _push2(`<div class="flex items-center space-x-4"${_scopeId}><div class="w-16 h-16 rounded-full bg-gradient-to-br from-blue-400 to-purple-600 flex items-center justify-center"${_scopeId}><span class="text-2xl"${_scopeId}>\u{1F464}</span></div><div class="flex-1"${_scopeId}><h3 class="text-xl font-semibold text-white mb-2"${_scopeId}>Nh\xE2n V\u1EADt</h3><p class="text-game-text-secondary mb-2"${_scopeId}>Qu\u1EA3n l\xFD thu\u1ED9c t\xEDnh, trang b\u1ECB v\xE0 k\u1EF9 n\u0103ng</p><div class="flex items-center space-x-4 text-sm"${_scopeId}><span class="text-yellow-400"${_scopeId}>Combat Power: ${ssrInterpolate(((_a2 = unref(characterStore).combatPower) == null ? void 0 : _a2.toLocaleString()) || "0")}</span><span class="text-purple-400"${_scopeId}>Level: ${ssrInterpolate(((_b2 = unref(player)) == null ? void 0 : _b2.level) || 1)}</span></div></div></div>`);
            } else {
              return [
                createVNode("div", { class: "flex items-center space-x-4" }, [
                  ...
                  createVNode("div", { class: "flex-1" }, [
                    ...
                    createVNode("div", { class: "flex items-center space-x-4 text-sm" }, [
                      createVNode("span", { class: "text-yellow-400" }, "Combat Power: " + toDisplayString(((_c2 = unref(characterStore).combatPower) == null ? void 0 : _c2.toLocaleString()) || "0"), 1),
                      createVNode("span", { class: "text-purple-400" }, "Level: " + toDisplayString(((_d2 = unref(player)) == null ? void 0 : _d2.level) || 1), 1)
                    ])
                  ])
                ])
              ];
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            var _a2, _b2;
            if (_push2) {
              _push2(`<div class="flex items-center space-x-4"${_scopeId}><div class="w-16 h-16 rounded-full bg-gradient-to-br from-green-400 to-blue-600 flex items-center justify-center"${_scopeId}><span class="text-2xl"${_scopeId}>\u{1F9D8}</span></div><div class="flex-1"${_scopeId}><h3 class="text-xl font-semibold text-white mb-2"${_scopeId}>Tu Luy\u1EC7n</h3><p class="text-game-text-secondary mb-2"${_scopeId}>N\xE2ng cao c\u1EA5p \u0111\u1ED9 v\xE0 c\u1EA3nh gi\u1EDBi</p><div class="flex items-center space-x-4 text-sm"${_scopeId}><span class="text-orange-400"${_scopeId}>Realm: ${ssrInterpolate(((_a2 = unref(player)) == null ? void 0 : _a2.realm) || "Ph\xE0m c\u1EA3nh")}</span><span class="text-purple-400"${_scopeId}>Huy\u1EC1n L\u1EF1c: ${ssrInterpolate(getResourceAmount("huyen_luc"))}</span></div></div></div>`);
            } else {
              return [
                createVNode("div", { class: "flex items-center space-x-4" }, [
                  ...
                  createVNode("div", { class: "flex-1" }, [
                    ...
                    createVNode("div", { class: "flex items-center space-x-4 text-sm" }, [
                      createVNode("span", { class: "text-orange-400" }, "Realm: " + toDisplayString(((_b2 = unref(player)) == null ? void 0 : _b2.realm) || "Ph\xE0m c\u1EA3nh"), 1),
