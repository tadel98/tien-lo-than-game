...
const useCharacterStore = defineStore("character", () => {
  ...
  const combatPower = computed(() => {
    var _a;
    return ((_a = stats.value) == null ? void 0 : _a.combatPower) || 0;
  });
  const totalStats = computed(() => {
    var _a;
    return ((_a = stats.value) == null ? void 0 : _a.total) || {};
  });
  const baseStats = computed(() => {
    var _a;
    return ((_a = stats.value) == null ? void 0 : _a.base) || {};
  });
...
//# sourceMappingURL=character-BBuP_n1i.mjs.map
