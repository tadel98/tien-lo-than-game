...
import { computed, ref, watch, unref, mergeProps, withCtx, createTextVNode, useSSRContext } from 'file://C:/Users/THE%20SUN/Desktop/TienLoThan/node_modules/vue/index.mjs';
...
const useCultivationStore = defineStore("cultivation", () => {
  ...
  const canCultivate = computed(() => {
    var _a;
    return ((_a = cultivationStatus.value) == null ? void 0 : _a.canCultivate) || false;
  });
  ...
  const progressPercentage = computed(() => {
    var _a, _b;
    return ((_b = (_a = cultivationStatus.value) == null ? void 0 : _a.cultivation) == null ? void 0 : _b.progressPercentage) || 0;
  });
  const currentRealm = computed(() => {
    var _a, _b;
    return ((_b = (_a = cultivationStatus.value) == null ? void 0 : _a.cultivation) == null ? void 0 : _b.realm) || "Ph\xE0m c\u1EA3nh";
  });
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const realmColor = computed(() => {
      var _a, _b, _c;
      const realm = ((_b = (_a = cultivationStatus.value) == null ? void 0 : _a.cultivation) == null ? void 0 : _b.realm) || ((_c = player.value) == null ? void 0 : _c.realm) || "Ph\xE0m c\u1EA3nh";
      return cultivationStore.getRealmColor(realm);
    });
    const realmProgress = computed(() => {
      var _a, _b;
      return (_b = (_a = cultivationStatus.value) == null ? void 0 : _a.cultivation) == null ? void 0 : _b.realmProgress;
    });
    const cultivationInfo = computed(() => {
      var _a, _b, _c;
      const level = ((_b = (_a = cultivationStatus.value) == null ? void 0 : _a.cultivation) == null ? void 0 : _b.currentLevel) || ((_c = player.value) == null ? void 0 : _c.level) || 1;
